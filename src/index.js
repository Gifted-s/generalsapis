...
*
*/
app.get(`${endpoint}/getmessage/:id`, makeCallback(getMessageController))
...
*
*/
app.get(`${endpoint}/listmessages`, makeCallback(listMessagesController))
...
*
*/
app.patch(`${endpoint}/editmessage/:id`, makeCallback(editMessageController))
...
*
*/
app.delete(`${endpoint}/deletemessage/:id`, makeCallback(deleteMessageController))
...
*
*/
app.post(`${endpoint}/addmessage`, makeCallback(putMessageController))
/**
* @swagger
...
*
*/
app.get(`${endpoint}/download/:id/:play`, makeCallback(downloadMesageController))
